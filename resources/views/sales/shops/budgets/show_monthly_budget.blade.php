...
<h1 class="h3 mb-2 text-gray-800">月別予実</h1>
<div class="container">
  ...
  <ul class="tab-list" id="tab-1">
    ...
    <li class="tab-item is-open">
      <a href="#shops_show" data-toggle>月別予実</a>
    </li>
    <li class="tab-item">
      <a href="#budget_show" data-toggle>詳細データ</a>
    </li>
  </ul>
          ...
          <nav class="panel panel-default">
             <table id="table" class="table table-bordered">
                ...
                <tr>
                    ...
                    <td>10,000,000</td>
                    <td>10,000,000</td>
                    <td><a href="/shops/budgets/show_daily_budget" class="btn btn-info btn-circle btn-sm">
