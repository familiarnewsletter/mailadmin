...
<div class="container">
  ...
  <ul class="tab-list" id="tab-1">
    ...
    <li class="tab-item">
      <a href="#meetinglog_index" data-toggle>企画ログ</a>
    </li>
    <li class="tab-item">
      <a href="#budget_index" data-toggle>販促ログ</a>
    </li>
  ...
  <div class="tab-content" id="meetinglog_index">
  	<div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">企画・打ち合わせ事項を記録</h6>
  ...
  <div class="tab-content" id="budget_index">
    ...
    <div class="card shadow mb-4">
                <!-- Card Header - Dropdown -->
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">別注企画ログ</h6>
                  <div class="dropdown no-arrow">
                    <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      <i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
                    </a>
