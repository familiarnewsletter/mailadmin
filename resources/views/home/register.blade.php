...
<head>
  ...
  <link href="sb_admin_2/vendor/fontawesome-free/css/all.css" rel="stylesheet" type="text/css">
            ...
            <div class="p-5">
              ...
              <form class="user">
                ...
                <div class="form-group">
                  <input type="email" class="form-control form-control-user" id="exampleInputEmail" placeholder="メールアドレス">
                </div>
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                  ...
                  <div class="col-sm-6">
                    <input type="password" class="form-control form-control-user" id="exampleRepeatPassword" placeholder="パスワード（確認用）">
                  </div>
                </div>
              ...
              <div class="text-center">
                <a class="small" href="/login">すでにアカウントをお持ちの方はログイン</a>
              </div>
            </div>
          </div>
        </div>
