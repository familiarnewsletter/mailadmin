                                            ...
                                            <tbody>
                                              <tr>
                                                <td style="width:185px;">
                                                  <img alt="Shop News & Event" height="auto" src="https://cdn.shopify.com/s/files/1/0640/3611/0585/files/head_shop-news-and-event.png" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="185">
                                                </td>
                                              </tr>
                                            </tbody>
                                          </table>
                    ...
                    <tr>
                      <td style="direction:ltr;font-size:0px;padding:0;text-align:center;">
                        ...
                        <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0;line-height:0;text-align:left;display:inline-block;width:100%;direction:ltr;">
                          <!--[if mso | IE]><table border="0" cellpadding="0" cellspacing="0" role="presentation" ><tr><td style="vertical-align:top;width:462px;" ><![endif]-->
                                              ...
                                              <tbody>
                                                <tr>
                                                  <td style="width:102px;"><!-- 変数: 遷移先URL -->
                                                    <a href="[[[{{ $url }}?utm_source=h_mail&utm_medium=email&utm_campaign=$$$トラッキングコード$$$&utm_content={{ $np->title }}{{ $anchor_id }}]]]" target="_blank"><!-- 変数: 画像URL -->
