...
<table width="600" border="0" cellpadding="0" cellspacing="0" align="center">
	<tbody>
		...
		<p>
			<!--▼▼ 画像タップ時のリンク ▼▼-->
			<a href="{{ $stylebook->link_url }}{{$utm_code}}{{ $newsletter->utm_campaign_id }}&utm_content={{ $stylebook->utm_content_id }}" target="_blank" style="margin:0;padding:0;vertical-align:top;font-size:0;text-decoration:none;">
			<!--▲▲ 画像タップ時のリンク ▲▲-->
			<!--▼▼ 画像 ▼▼-->
