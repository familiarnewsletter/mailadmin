...
<h1 class="h3 mb-2 text-gray-800">リンク編集</h1>

      <div class="card shadow mb-4">
        <div class="card-header py-3">
          <h6 class="m-0 font-weight-bold text-primary">編集項目</h6>
        </div>
        <div class="card-body">
          ...
          <nav class="panel panel-default">
             ...
             <form action="{{ route('newsletter.updatelink', ['newsletter_link_id' => $newsletter_link->id]) }}" method="post">
                @csrf
                ...
                <div class="form-group">
                   <p id="comt" >リンク先URL</p>
                  <input type="text" class="form-control" name="link_url" id="link_url" value="{{ $newsletter_link->link_url }}"/>
                </div>

                <div class="form-group">
                   <label for="utm_content_id">キャンペーンコード(2桁)</label>
                  <input type="text" class="form-control" name="utm_content_id" id="utm_content_id" value="{{ $newsletter_link->utm_content_id }}"/>
                </div>
