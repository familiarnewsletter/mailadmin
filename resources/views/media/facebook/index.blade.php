...
<h1 class="h3 mb-2 text-gray-800">Facebook</h1>
<div class="container">
  ...
  <ul class="tab-list" id="tab-1">
    ...
    <li class="tab-item is-open">
      <a href="#follower_index" data-toggle>友達分析</a>
    </li>
    <li class="tab-item">
      <a href="#post_index" data-toggle>投稿分析</a>
    </li>
    <li class="tab-item">
  ...
  <div class="tab-content is-open" id="follower_index">
     ...
     <div class="card shadow mb-4">
        ...
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
          <h6 class="m-0 font-weight-bold text-primary">友達数</h6>
